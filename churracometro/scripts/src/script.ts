...
function barbCalc() {
    let adultQuant = parseInt((document.getElementById('adultQuant') as HTMLInputElement).value)
    let childQuant = parseInt((document.getElementById('childQuant') as HTMLInputElement).value)
    let barbDur = parseInt((document.getElementById('barbDur') as HTMLInputElement).value)
